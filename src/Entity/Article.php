...
class Article
{
    ...
    /**
     * @ORM\ManyToMany(targetEntity=Contributor::class, inversedBy="articles")
     */
    private $authors;
    ...
    public function addAuthor(Contributor $author): self
    {
    ...
    public function removeAuthor(Contributor $author): self
    {
